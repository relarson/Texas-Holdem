// I do NOT suggest that this class be edited. It checks for hands,
// which is obviously a very important thing to have working correctly.
package texas;
public class HandChecker
{
    private int a=0, handvalue=-1, pc1, pc2, fc1, fc2;
        ...
        if (a == 9)
         {
            ...
            for(int abc : psuit)
                System.out.print(abc + " ");
            System.out.print("\nCface-Chck: ");
            for(int def : compface)
                System.out.print(def + " ");
            System.out.print("\nCsuit-Chck: ");
            for(int abc : compsuit)
                System.out.print(abc + " ");
            System.out.println("");
         }
          */
    ...
    public void storeCards(int a, String str)
    {
        if (str.equals("pc1"))
            cards[0] = a;
        else if (str.equals("pc2"))
            cards[1] = a;
        else if (str.equals("fc1"))
            cards[2] = a;
            ...
            for (int af=0;af<13;af++)
            {
                if (pface[af] >=2 && af != first && first >=0)
                {
                    ...
                    if (first == 0){
                        storeCards(13,"fc1");
                        storeCards(af,"fc2");
                        //System.out.println("f: " + first + ", s: " + af);
                    }
                    else if (af == 0){
                        storeCards(first,"fc1");
                        storeCards(13,"fc2");
                        //System.out.println("f: " + first + ", s: " + af);
                    }
                    else {
    ...
    public boolean flush(String l)
    {
        ...
        if (temp.equals("player"))
        {
            for (int q = 0; q<4; q++)
            {
                if (psuit[q] >= 5)
                {
                    for (int high = q*13 ; high <= ((q+1)*13)-1 ; high ++)
                    {
                        if (phand[high] >= 1)
                        {
                            if (high == 0)
    ...
    public boolean twopair(String o)
    {
        ...
        if (temp.equals("player"))
        {
            ...
            if (first == -1)
                return false;
            for (int ad=12;ad>0;ad--)
            {
                if (pface[ad] >=2 && ad != first)
                {
                    if (first == 0)
                        handvalue = 87 + (ad-1);
                    else
